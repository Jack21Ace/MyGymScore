...
from Enums import Eps, Gender, Purpose, Rh, Type, PayMethod, Ranking, Role, UpperBody, LowerBody, Conditioning, ConsumableType, AccessoryType
...
print("\n" + userSchedule.__str__() + "\n")
# USER
print("==========//==========//USER//==========//==========")
person1 = User(1054995036, "Maicol Antonio", "Machete", Gender.MALE, "3012232219", "3148947223", "jack2119hv@gmail.com", "316497", "Manizales", 1.78, 78, True, Purpose.TONE_UP, Rh.O_NEGATIVE, Eps.SURA, date(1994,3,13), Employee, medicalControl1.__str__(), userSchedule.__str__())
print("\n" + person1.__str__() + "\n")
# CAMPUS
print("==========//==========//CAMPUS//==========//==========")
campus = Campus(976431258, "Iron GYM", "8845632", "Villamaria", True, 13, False, person1.getName())
print("\n" + campus.__str__() + "\n")
# BILL
print("==========//==========//BILL//==========//==========")
bill = Bill(987456213, 123456789, "Arturo", "3105487425", "kr 25 # 24-13", date(2021, 3, 13), campus.getCampusName())
print("\n" + bill.__str__() + "\n")
# GYM
print("==========//==========//GYM//==========//==========")
gym1 = Gym(3453, 'Big Boys', 'Malabar', '3189086655')
print("\n" + gym1.__str__() + "\n")
